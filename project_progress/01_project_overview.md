...
Цель: локальный Telegram‑бот (Windows 10, long polling), который принимает голос/аудио/видео
...
- Поддержка voice/audio/video/video_note/документов (ogg/opus, mp3, m4a, wav, webm, flac, mp4, avi, mov, mkv)
